...
var iconMarkup = map[string]string{
	...
	"copy":         iconTag("copy", `<rect x="8" y="8" width="11" height="11" rx="2"/><path d="M16 8V6a2 2 0 0 0-2-2H6a2 2 0 0 0-2 2v8a2 2 0 0 0 2 2h2"/>`),
	"trash":        iconTag("trash", `<path d="M4 7h16M9 7V4.5h6V7M7 7l1 13h8l1-13M10 11v5M14 11v5"/>`),
	"undo":         iconTag("undo", `<path d="M9 7 5 11l4 4"/><path d="M5 11h8a6 6 0 0 1 6 6"/>`),
	"redo":         iconTag("redo", `<path d="m15 7 4 4-4 4"/><path d="M19 11h-8a6 6 0 0 0-6 6"/>`),
	...
	"select-multi": iconTag("select-multi", `<rect x="3.5" y="3.5" width="10" height="10" rx="1.4"/><rect x="10.5" y="10.5" width="10" height="10" rx="1.4"/>`),
